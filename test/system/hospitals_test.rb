...
class HospitalsTest < ApplicationSystemTestCase
  ...
  test "creating a Hospital" do
    ...
    fill_in "Caption", with: @hospital.caption
    fill_in "Description", with: @hospital.description
    fill_in "Hospital Image", with: @hospital.hospital_image
    fill_in "Latitude", with: @hospital.latitude
    fill_in "Longitude", with: @hospital.longitude
    fill_in "Name", with: @hospital.name
    fill_in "Pet", with: @hospital.pet
    fill_in "Tag", with: @hospital.tag
    fill_in "Tel", with: @hospital.tel
    fill_in "Time", with: @hospital.time_id
